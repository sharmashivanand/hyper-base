...
function hybrid_register_styles() {
	...
	wp_register_style( 'hyper-base-five', HYBRID_CSS . "one-five{$suffix}.css" );
	...
	// Use the RTL style for the hyper-base-five style.
	$wp_styles->add_data( 'hyper-base-five', 'rtl', 'replace' );

	// Adds the suffix for the hyper-base-five RTL style.
	if ( $suffix )
		$wp_styles->add_data( 'hyper-base-five', 'suffix', $suffix );
}
