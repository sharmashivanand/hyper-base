...
add_action( 'after_setup_theme', 'hyper_base_custom_background_setup', 15 );
 ...
 * @return void
 */
function hyper_base_custom_background_setup() {
	...
	add_theme_support(
		...
		array(
			...
			'default-image'    => '',
			'wp-head-callback' => 'hyper_base_custom_background_callback',
		)
	);
}
 ...
 * @return void
 */
function hyper_base_custom_background_callback() {
